...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row2 = new MessageActionRow().addComponents(new MessageButton().setLabel('Empfang').setCustomId('empfangtools').setStyle('PRIMARY'))
    const row3 = new MessageActionRow().addComponents(new MessageButton().setLabel('Dev').setCustomId('devtools').setStyle('PRIMARY'))
    var addthis = []
    addthis.push(row1)
